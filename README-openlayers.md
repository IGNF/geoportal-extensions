...
<link rel="stylesheet" href="chemin/vers/openlayers/ol.css" />
<script src="chemin/vers/openlayers/ol.js"></script>

<!-- Extension Géoportail pour OpenLayers 3 -->
<script src="chemin/vers/GpPluginOL.js"></script>
<link rel="stylesheet" href="chemin/vers/GpPluginOL.css" />
```
...
``` html
<script data-key="VOTRE-CLEF" src="chemin/vers/GpPluginOL.js"></script>
```
...
<html>
    <head>
        ...
        <!-- Extension Géoportail pour OpenLayers 3 -->
        <link rel="stylesheet" href="GpPluginOL.css" />
        <script src="GpPluginOL.js" data-key="CLEAPI"></script>
    </head>
    <body>
        <script>
...
<html>
    <head>
        ...
        <!-- Extension Géoportail pour OpenLayers 3 -->
        <link rel="stylesheet" href="GpPluginOL.css" />
        <script src="GpPluginOL.js"></script>
    </head>
    <body>
        <script>
            window.onload = function () {
...
<html>
    <head>
        <!-- Library OpenLayers 3 -->
        ...
        <script src="GpPluginOL.js" data-url="chemin/vers/autoconf.json"></script>
    </head>
    <body>
        <script>
            window.onload = function () {
