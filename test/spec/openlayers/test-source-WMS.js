    ...
    describe("-- Test source WMS--", function () {
        ...
        describe('Création d\'une source WMS, sans chargement de l\'autoconf', function() {
            ...
            before(function (done) {
                require(['Openlayers/Layers/SourceWMS'], function (_WMS) {
                    WMS = _WMS;
                    done();
                });
            });
            ...
            it('Comportement : Erreur appelant à charger l\'autoconf', function() {
                try {
                    ...
                    console.log(e);
                    expect(e).to.have.property("message", "ERROR : contract key configuration has to be loaded to load Geoportal layers. See http://ignf.github.io/evolution-apigeoportail/openlayers/openlayers-autoconf.html");
                }
            })
        })
            ...
            beforeEach(function (done) {
                require(['Openlayers/Layers/SourceWMS'], function (_WMS) {
                    configWMS = Gp.Services.getConfig({
                        ...
                        serverUrl : "./spec/openlayers/resources/AutoConf.js",
                        callbackSuffix : "",
