    ...
    return smp.wrap({
        entry : {
            ...
            "Common" : [
                ...
                path.join(ROOT, "src", "Leaflet", "Styles.js")
            ],
            // Controles
            "Controls" : path.join(ROOT, "src", "Leaflet", "Controls", "Controls.js"),
            "ElevationPath" : path.join(ROOT, "src", "Leaflet", "Controls", "ElevationPath.js"),
            "Isocurve" : path.join(ROOT, "src", "Leaflet", "Controls", "Isocurve.js"),
            "LayerSwitcher" : path.join(ROOT, "src", "Leaflet", "Controls", "LayerSwitcher.js"),
            "MousePosition" : path.join(ROOT, "src", "Leaflet", "Controls", "MousePosition.js"),
            "ReverseGeocode" : path.join(ROOT, "src", "Leaflet", "Controls", "ReverseGeocoding.js"),
            "Route" : path.join(ROOT, "src", "Leaflet", "Controls", "Route.js"),
            "SearchEngine" : path.join(ROOT, "src", "Leaflet", "Controls", "SearchEngine.js"),
            // Formats/Couches
            "Layers" : path.join(ROOT, "src", "Leaflet", "Layers", "Layers.js"),
            "WMTS" : path.join(ROOT, "src", "Leaflet", "Layers", "WMTS.js"),
            "WMS" : path.join(ROOT, "src", "Leaflet", "Layers", "WMS.js"),
            // Projections
            ...
            new HandlebarsPlugin(
                {
                    ...
                    context : {
                        samples : () => {
                            ...
                            var list = glob.sync(path.join(_root, "**", "*-modules-*.html"));
