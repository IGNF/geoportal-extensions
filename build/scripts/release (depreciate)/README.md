...
A partir de ce depot (central), on va publier sur **npm** ainsi que sur **github**,
les **binaires** pour **OpenLayers** et **Leaflet**.

Les publications contiennent les fichiers binaires ainsi que des fichiers d'information
(LICENCE, README, ...) :
    dist/.js
    dist/.css
    src/.js
